#eu,como dono de uma padaria, qiero um sistema onde eu possa cadastrar meus produtos além de poder listar, alterar em caso de error, e excluir quando acabar o estoque. quero 
#também que tenha um menu onde eu possa ver as opções possiveis

#sou o dono de uma concessionária e vi o sistema do dono da padaria. Gostaria de um sistema igual para meus carros.

#explique porque quando tenho mais de um atributo (variável), torna-se dificíl/complicado o uso de arquivos.txt para guardar as informações  
